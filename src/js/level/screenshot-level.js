...
import { AxeShieldTankEnemy } from '../entities/characters/enemyies.js'
...
export default class ScreenshotLevel extends Level {
  constructor() {
    super()
    ...
    g.MOUSE_POSITION.x = Number.MAX_SAFE_INTEGER
    g.MOUSE_POSITION.y = g.CANVAS_HEIGHT / 2
    Keyboard.DOWN[39] = true
    ...
    const announcement = this.scene.add(
      new Announcement(nomangle('Path to Glory')),
    )
    announcement.age = 1
